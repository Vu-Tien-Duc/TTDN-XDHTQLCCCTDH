                              ...
                              <div className="space-y-2 min-h-[100px]">
                                {cellSchedules.length > 0 ? (
                                  cellSchedules.map((sch) => {
                                    ...
                                    const userDept =
                                      schUser && typeof schUser.departmentId === 'object' && schUser.departmentId !== null
                                        ? (schUser.departmentId as Department).name
                                        : '';

                                    return (
                                      <div
                                        key={sch._id}
                                        className={`p-2.5 rounded-lg border text-left shadow-xs transition-all hover:shadow-md ${theme.bg} ${theme.border} group/card relative`}
                                      >
                                        {/* Phòng học & Badge */}
                      ...
                      <tr key={sch._id} className="hover:bg-gray-50/60 transition-colors">
                        ...
                        <td className="py-3.5 px-4 text-gray-600">
                          <div className="flex items-center gap-1">
                            ...
                            <span>{userDept || 'Chưa phân bổ'}</span>
                          </div>
                        </td>
