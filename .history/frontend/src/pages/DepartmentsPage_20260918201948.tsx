        ...
        {nodes.map((node) => {
          ...
          return (
            <div key={node._id} className="group">
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-300 hover:shadow-xs transition">
              ...
              {formData.type === 'bomon' && (
                <div>
                  ...
                  >
                    ...
                    {flatDepartments
                      .filter((d) => d.type === 'khoa' && d._id !== selectedDept?._id)
                      .map((k) => (
