...
export const DashboardPage: React.FC = () => {
  ...
  const handleCheckOut = async (attendanceId?: string, shiftIdRaw?: unknown) => {
    const shiftId =
      typeof shiftIdRaw === 'object' && shiftIdRaw !== null
        ? (shiftIdRaw as { _id?: string })._id
        : (shiftIdRaw as string | undefined);
            ...
            <>
              <div className="mt-2 flex items-center justify-between">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => handleCheckOut(activeOpenLog._id, activeOpenLog.shiftId)}
                              ...
                              return (
                                <div className="flex items-center gap-2">
                                  ...
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    onClick={() => handleCheckOut(log._id, item.shiftId)}
