          ...
          {forgotMode ? (
            <div className="space-y-4">
              <div className="rounded-2xl border border-blue-200 bg-blue-50 p-3 text-xs text-blue-700">
                <div className="font-bold mb-1">Khôi phục mật khẩu</div>
                <div>Admin cấp tài khoản là flow chính. OTP chỉ dùng cho khôi phục mật khẩu và xác minh an toàn.</div>
              </div>

              <div className="flex items-center justify-between gap-2 text-[10px] font-bold uppercase tracking-wider text-slate-500">
                <div className={`flex-1 rounded-full px-2 py-1 text-center ${forgotStep === 0 ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                  1. Email
                </div>
                <div className={`flex-1 rounded-full px-2 py-1 text-center ${forgotStep === 1 ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                  2. OTP
                </div>
                <div className={`flex-1 rounded-full px-2 py-1 text-center ${forgotStep === 2 ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                  3. Mật khẩu
                </div>
              </div>
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50"
                    >
                      Quay lại
                    </button>
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl text-white font-bold text-xs bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
                    >
                      Tiếp tục
                    </button>
                  </div>
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={forgotLoading}
                      className="flex-1 py-2.5 rounded-xl text-white font-bold text-xs bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 transition disabled:opacity-60"
                    >
                      {forgotLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : null}
