...
export const MainLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside
        className={cn(
          'fixed lg:sticky lg:top-0 lg:h-screen lg:self-start inset-y-0 left-0 z-50 shrink-0 bg-gradient-to-b from-slate-950 via-[#0a1228] to-slate-950 text-slate-200 flex flex-col transition-all duration-300 ease-in-out border-r border-slate-800/80 shadow-2xl lg:shadow-none print:hidden select-none',
      ...
      >
        {/* 1. Brand Header */}
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-800/80 bg-slate-950/60 backdrop-blur-md shrink-0">
          {isSidebarCollapsed ? (
            <Link
              to="/dashboard"
        ...
        {isSidebarCollapsed ? (
          ...
          <div className="p-3 mx-3 my-2.5 rounded-2xl bg-slate-900/80 border border-slate-800/80 flex items-center justify-between gap-3 shadow-xs backdrop-blur-sm group/user shrink-0">
        ...
        <div className="flex-1 overflow-y-auto px-2 py-1 space-y-3 sidebar-scrollbar">
        ...
        {/* 4. Sidebar Footer */}
        <div className="p-3 border-t border-slate-800/80 bg-slate-950/60 backdrop-blur-md shrink-0">
          {isSidebarCollapsed ? (
        ...
        <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs print:hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative">
              ...
              {/* Popover thông báo thực tế - Tối ưu cho cả Desktop & Mobile */}
              {showNotifications && (
                <>
                  ...
                  <div className="fixed left-3 right-3 top-16 sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-2 sm:w-[380px] bg-white rounded-2xl shadow-xl border border-slate-200 p-3.5 sm:p-4 z-50 animate-in fade-in slide-in-from-top-2 max-h-[82vh] flex flex-col">
                    {/* Header đơn giản, gọn gàng */}
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          onClick={() => {
                            ...
                            setUnreadCount(0);
                            toast.success('Đã đánh dấu đọc tất cả', { id: 'read-all-noti', duration: 1500 });
                          }}
                          className="px-2 py-1 text-[11px] font-semibold text-slate-500 hover:text-blue-600 hover:bg-slate-50 rounded-lg transition"
                        >
                          Đã đọc
                        </button>
                        <button
                          ...
                          className="px-2 py-1 text-[11px] font-semibold text-slate-500 hover:text-blue-600 hover:bg-slate-50 rounded-lg transition flex items-center gap-1"
                        >
                    ...
                    {isLoadingNotifications ? (
                      ...
                      <div className="py-8 text-center text-xs text-slate-400 flex flex-col items-center gap-1.5">
                        ...
                        <span className="font-medium text-slate-600">Không có thông báo mới</span>
                        <span className="text-[11px] text-slate-400">Các cập nhật chấm công, đơn từ sẽ hiển thị ở đây.</span>
                      </div>
                    ) : (
                      <div className="space-y-2 overflow-y-auto max-h-[380px] pr-0.5 custom-scrollbar">
                        {notifications.map((item) => {
                          ...
                          return (
                            <div
                              ...
                              className="p-3 rounded-xl bg-slate-50 hover:bg-blue-50/50 transition cursor-pointer border border-slate-200/80 group text-left"
                            >
                              <div className="flex items-start justify-between gap-2">
                                <p className="font-bold text-xs text-slate-900 group-hover:text-blue-600 transition leading-snug">
                                  {item.title}
                                </p>
                                <span
                                  className={cn(
