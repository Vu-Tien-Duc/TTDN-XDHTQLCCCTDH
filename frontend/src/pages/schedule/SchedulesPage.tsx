...
export const SchedulesPage: React.FC = () => {
  ...
  const handleOpenEditModal = (sch: Schedule) => {
    ...
    const schUserId = typeof sch.userId === 'object' && sch.userId !== null ? (sch.userId as User)._id : ((sch.userId as unknown as string) || '');
    const schShiftId = typeof sch.shiftId === 'object' && sch.shiftId !== null ? (sch.shiftId as ShiftConfig)._id : ((sch.shiftId as unknown as string) || '');
